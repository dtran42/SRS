...
namespace WF.Sample.Business.Workflow
{
    public static class WorkflowInit
    {
        ...
        public static async Task<IEnumerable<string>> UsersInRoleAsync(string roleName, Guid? processId = null)
        {
            ...
            var usersInRole = provider.GetInRole(roleName);
            return usersInRole;
        }
        ...
        static void _runtime_ProcessStatusChanged(object sender, ProcessStatusChangedEventArgs e)
        {
            ...
            DataServiceProvider.Get<IWorkOrderRepository>().DeleteEmptyPreHistory(e.ProcessId);
            ...
            if (!e.IsSubprocess)
            {
                ...
                var docRepository = DataServiceProvider.Get<IWorkOrderRepository>();
